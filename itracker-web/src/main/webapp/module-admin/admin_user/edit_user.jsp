...
<html:form action="/edituser" method="post" acceptCharset="UTF-8" enctype="multipart/form-data"
   ...
   <table border="0" cellspacing="0" cellspacing="1" width="800px">
      ...
      <tr>
         ...
         <c:choose>
            <c:when test="${isUpdate && !allowProfileUpdate}">
               <td class="editColumnText">${ edituser.firstName }
      ...
      <tr>
         ...
         <c:choose>
            <c:when test="${isUpdate && !allowProfileUpdate}">
               <td class="editColumnText">${ edituser.lastName }
      ...
      <tr>
         ...
         <c:choose>
            <c:when test="${isUpdate && !allowProfileUpdate}">
               <td class="editColumnText">${edituser.email}
            ...
            <c:when test="${isUpdate && !allowProfileUpdate}">
               <c:choose>
                  <c:when test="${edituser.superUser}">
                     <td class="editColumnText"><it:message key="itracker.web.generic.yes"/><html:hidden
                             property="superUser"/></td>
                  </c:when>
                  <c:otherwise>
                     <td class="editColumnText"><it:message key="itracker.web.generic.no"/><html:hidden
                             property="superUser"/></td>
                  </c:otherwise>
               </c:choose>
            </c:when>
