...
<table border="0" cellspacing="0" cellspacing="1" width="100%" class="shadeList">
   <tr>
      <td width="47%" style="vertical-align: top; white-space: nowrap">
         <table border="0" cellspacing="0" cellspacing="1" width="100%">
            ...
            <c:forEach items="${ statuses }" var="status" varStatus="i">
               <tr class="${ i.index %2 == 0?'listRowUnshaded' : 'listRowShaded'}">
                  <td style="text-align: left; white-space: nowrap">${ it:getStatusName(status.value, pageLocale) }
                     (${ status.value })
                  </td>
                  <td style="text-align: right; white-space: nowrap">
                     <it:link action="editconfigurationform" targetAction="update" paramName="id"
                              paramValue="${ status.id }"
      ...
      <td width="47%" style="vertical-align: top; white-space: nowrap">
         <table border="0" cellspacing="0" cellspacing="1" width="100%">
            <tr>
               ...
               <td class="listRowUnshaded" style="text-align: right;">
                  <span style="text-align: right"><it:link action="editconfigurationform" targetAction="createseverity"
                                                           titleKey="itracker.web.admin.listconfiguration.severity.create.alt"><it:message
                          key="itracker.web.admin.listconfiguration.severity.create"/></it:link></span>
               </td>
            </tr>
            <c:forEach items="${ severities }" var="severity" varStatus="i" step="1">
               <tr class="${ i.index %2 == 0?'listRowUnshaded' : 'listRowShaded'}">
                  <td style="text-align: left; white-space: nowrap">${ it:getSeverityName(severity.value, pageLocale) }
                     (${ severity.value })
                  </td>
                  <td style="text-align: right; white-space: nowrap">
                     <c:if test="${ i.index != 0 }">
                        <it:link action="orderconfiguration" targetAction="up" paramName="id"
                                 paramValue="${ severity.id }"
   ...
   <tr>
      <td colspan="2"><html:img module="/" page="/themes/defaulttheme/images/blank.gif" width="1" height="12"/></td>
   </tr>
   <tr>
      <td width="47%">
         <table border="0" cellspacing="0" cellspacing="1" width="100%">
            <tr>
               ...
               <td class="listRowUnshaded" style="text-align: right;">
                  <it:link action="editconfigurationform" targetAction="createresolution"
            ...
            <c:forEach items="${ resolutions }" var="resolution" varStatus="i" step="1">
               <tr class="${ i.index %2 == 0?'listRowUnshaded' : 'listRowShaded'}">
                  <td style="text-align: left; white-space: nowrap">${ it:getResolutionName(resolution.value, pageLocale) }
                     (${ resolution.value })
                  </td>
                  <td style="text-align: right; white-space: nowrap">
                     <c:if test="${ i.index != 0 }">
                        <it:link action="orderconfiguration" targetAction="up" paramName="id"
                                 paramValue="${ resolution.id }"
      ...
      <td width="47%" style="vertical-align: top; white-space: nowrap">
         <table border="0" cellspacing="0" cellspacing="1" width="100%">
            <tr>
               <td style="text-align: left; white-space: nowrap" class="editColumnTitle"><it:message
                       key="itracker.web.attr.customfields"/>:
               </td>
               <td class="listRowUnshaded" style="text-align: right;">
                  <span style="text-align: right; white-space: nowrap"><it:link action="editcustomfieldform"
                                                                                targetAction="create"
                                                                                titleKey="itracker.web.admin.listconfiguration.customfield.create.alt"><it:message
                          key="itracker.web.admin.listconfiguration.customfield.create"/></it:link></span>
               </td>
            </tr>
