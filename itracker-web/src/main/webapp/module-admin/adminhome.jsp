...
<table border="0" cellspacing="0" cellspacing="1" width="800px">
   ...
   <tr class="listHeading">
      ...
      <td colspan="2" align="right"><it:link action="editprojectform" targetAction="create" styleClass="editColumnText">[<it:message
              key="itracker.web.attr.create"/>]</it:link>
         <it:link forward="listprojectsadmin" styleClass="editColumnText">[<it:message
                 key="itracker.web.attr.administer"/>]</it:link></td>
   </tr>
   ...
   <tr class="listHeading">
      ...
      <td colspan="2" align="right"><it:link forward="listusers" styleClass="editColumnText">[<it:message
   ...
   <tr class="listHeading">
      ...
      <td colspan="2" align="right"><it:link forward="listreportsadmin" styleClass="editColumnText">[<it:message
              key="itracker.web.attr.administer"/>]</it:link></td>
   </tr>
   <tr class="listRowUnshaded">
   ...
   <tr class="listHeading">
      ...
      <td colspan="2" align="right">
         ...
         <it:link forward="listconfiguration" styleClass="editColumnText">[<it:message
                 key="itracker.web.attr.administer"/>]</it:link>
      </td>
   </tr>
   <tr class="listRowUnshaded">
   ...
   <tr class="listHeading">
      ...
      <td colspan="2" align="right"><it:link forward="listattachments" styleClass="editColumnText">[<it:message
              key="itracker.web.attr.administer"/>]</it:link></td>
   </tr>
   ...
   <tr class="listRowUnshaded">
      <td class="editColumnTitle"><it:message key="itracker.web.attr.totalnumber"/>:</td>
      <td class="editColumnText">
         <fmt:formatNumber value="${allIssueAttachmentsTotalNumber}"/><!-- ih.getAllIssueAttachmentsTotalNumber() --></td>
      <td></td>
      <td class="editColumnTitle"><it:message key="itracker.web.attr.totalsize"/>:</td>
      <td class="editColumnText">
         <fmt:formatNumber value="${allIssueAttachmentsTotalSize}" pattern="0.##"/><!-- ih.getAllIssueAttachmentsTotalSize() -->
         <it:message key="itracker.web.generic.kilobyte"/></td>
   </tr>
