   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-sm-6">
            <div class="form-group">
               <label><it:message
                       key="itracker.web.attr.login"/>:</label>
               <p class="form-control-static">${ edituser.login }</p>
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group">
               <label><it:message
                       key="itracker.web.attr.status"/>:</label>
      ...
      <div class="row">
         <div class="col-sm-6 col-sm-push-6">
            <div class="form-group">
               ...
               <p class="form-control-static text-nowrap"><it:formatDate date="${ edituser.createDate }"/></p>
            </div>

            <div class="form-group">
               <label><it:message key="itracker.web.attr.lastmodified"/>:</label>
               <p class="form-control-static text-nowrap"><it:formatDate date="${edituser.lastModifiedDate}"/></p>
            </div>
         </div>
      ...
      <div class="row">
         <div class="col-sm-6">
            ...
            <div class="alert alert-info"><p><sup>*</sup><it:message
                    key="itracker.web.generic.reqfield"/></p></div>
         </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            <h4><it:message key="itracker.web.attr.preferences"/>:</h4>
         </div>
      </div>
         ...
         <div class="col-sm-6">
               ...
               <c:choose>
                  <c:when test="${allowPreferenceUpdate}">
                     ...
                     <div class="radio-inline">
                        ...
                        <label for="showClosedOnIssueList_0"><it:message key="itracker.web.generic.no"/></label>
                     </div>
                     </p>
                  </c:when>
                  <c:otherwise>
            ...
            <div class="form-group">
               ...
               <c:choose>
                  ...
                  <c:otherwise>
                     <td class="form-control-static">${getRememberLastSearchLocalized}</td>
                  </c:otherwise>
               </c:choose>
            </div>
               ...
               <c:choose>
                  <c:when test="${allowPreferenceUpdate}">
                     ...
                     <div class="checkbox-inline"><html:multibox
                             ...
                             value="${ PREF_HIDE_ASSIGNED }"/> <label for="hiddenIndexSections_0"><it:message
                             key="itracker.web.editprefs.section.assigned"/>
                     </label></div>
                     <div class="checkbox-inline"><html:multibox
                             property="hiddenIndexSections" styleId="hiddenIndexSections_1"
                             value="${ PREF_HIDE_UNASSIGNED }"/> <label for="hiddenIndexSections_1"><it:message
