...
<html:form action="/editissue" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-sm-pull-2"><label><it:message key="itracker.web.attr.description"/>:</label>
    ...
    <div class="row">
        <div class="col-sm-6"><label><it:message key="itracker.web.attr.status"/>:</label>
            <c:choose>
