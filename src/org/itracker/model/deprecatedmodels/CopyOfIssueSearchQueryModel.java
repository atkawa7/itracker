...
public class CopyOfIssueSearchQueryModel implements Serializable {
    public static final Integer TYPE_FULL = new Integer(1);
    public static final Integer TYPE_PROJECT = new Integer(2);

    private List<ProjectModel> availableProjects = new ArrayList<ProjectModel>();
    ...
    private List<IssueModel> results = null;

    public CopyOfIssueSearchQueryModel() {
    }

    public List<ProjectModel> getAvailableProjects() {
        return availableProjects;
    }

    public void setAvailableProjects(List<ProjectModel> value) {
    ...
    public List<IssueModel> getResults() {
        return results;
    }

    public void setResults(List<IssueModel> value) {
        results = value;
    }
}
