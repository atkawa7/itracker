...
public class IssueUtilities {
	...
	public static int getFieldType(Integer fieldId) {
		if (fieldId != null) {
			...
			/*
			 * switch(fieldId.intValue()) { case FIELD_COMPONENTS: return
			 * FIELD_TYPE_INDEXED; case FIELD_VERSIONS: return
			 * FIELD_TYPE_INDEXED; }
			 */
		}
	 ...
	 * 
	 * @param locale
	 *            the locale to return the severities as
	 ...
	 * 
	 * @param locale
	 *            the locale to return the resolutions as
...
//	}
	 ...
	 *            the id of the field to return
	 * @param locale
	 *            the locale to initialize any labels with
	 * @return the requested CustomField object, or a new field if not found
	 */
	 ...
	 * 
	 * @param issue
	 *            an IssueModel of the issue to check view permission for
	 * @param user
	 *            a User for the user to check permission for
	 * @param permissions
	 *            a HashMap of the users permissions
	 */
	 ...
	 *            an IssueModel of the issue to check view permission for
	 * @param userId
	 *            the userId of the user to check permission for
	 * @param permissions
	 *            a HashMap of the users permissions
	 */
	 ...
	 * 
	 * @param issue
	 *            an IssueModel of the issue to check edit permission for
	 * @param userId
	 *            the userId of the user to check permission for
	 * @param permissions
	 *            a HashMap of the users permissions
	 ...
	 * 
	 * @param issue
	 *            an IssueModel of the issue to check assign permission for
	 * @param userId
	 *            the userId of the user to check permission for
	 * @param permissions
	 *            a HashMap of the users permissions
