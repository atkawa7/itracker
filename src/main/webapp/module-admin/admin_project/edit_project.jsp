...
<tr>
    ...
    <td valign="top" class="editColumnText">
        <html:select property="status" styleClass="editColumnText">
            <html:option value="<%= Integer.toString(Status.ACTIVE.getCode()) %>">
                <%= ProjectUtilities.getStatusName(Status.ACTIVE, (java.util.Locale) pageContext.getAttribute("currLocale")) %>
            </html:option>
            <html:option value="<%= Integer.toString(Status.VIEWABLE.getCode()) %>">
                <%= ProjectUtilities.getStatusName(Status.VIEWABLE, (java.util.Locale) pageContext.getAttribute("currLocale")) %>
            </html:option>
            <html:option value="<%= Integer.toString(Status.LOCKED.getCode()) %>">
                <%= ProjectUtilities.getStatusName(Status.LOCKED, (java.util.Locale) pageContext.getAttribute("currLocale")) %>
            </html:option>
        </html:select>
    </td>
</tr>
...
<tr>
    ...
    <td valign="top" class="editColumnText" nowrap>
        <html:select property="users" size="5" multiple="true" styleClass="editColumnText">
            ...
            <html:option
                    value="<%= users.get(i).getId().toString() %>"><%= users.get(i).getFirstName() + " " + users.get(i).getLastName() %>
            </html:option>
        ...
        <html:select property="permissions" size="5" multiple="true" styleClass="editColumnText">
            ...
            <html:option value="<%= permissionNames.get(i).getValue() %>"><%= permissionNames.get(i).getName() %>
            </html:option>
...
<tr>
    <td colspan="4">
        <html:img module="/" page="/themes/defaulttheme/images/blank.gif" height="15" width="1"/>
    </td>
</tr>

<tr class="editColumnTitle">
    <td colspan="4"><it:message key="itracker.web.admin.editproject.options"/>:</td>
</tr>
    ...
    <td colspan="2" valign="top">
        <table width="100%" cellspacing="0" cellspacing="1" border="0">
            ...
            <tr>
                <td class="editColumnText">
                    <html:multibox property="options"
                                   value="<%= Integer.toString(ProjectUtilities.OPTION_SURPRESS_HISTORY_HTML) %>"/>
                </td>
            ...
            <tr>
                <td class="editColumnText">
                    <html:multibox property="options"
                                   value="<%= Integer.toString(ProjectUtilities.OPTION_PREDEFINED_RESOLUTIONS) %>"/>
                </td>
            ...
            <tr>
                <td class="editColumnText">
                    <html:multibox property="options"
                                   value="<%= Integer.toString(ProjectUtilities.OPTION_ALLOW_ASSIGN_TO_CLOSE) %>"/>
                </td>
            ...
            <c:if test="${allowSelfRegister}">
                <tr>
                    <td class="editColumnText"><html:multibox property="options"
                                                              value="<%= Integer.toString(ProjectUtilities.OPTION_ALLOW_SELF_REGISTERED_CREATE) %>"/></td>
    ...
    <td colspan="2" valign="top">
        <table width="100%" cellspacing="0" cellspacing="1" border="0">
            ...
            <tr>
                <td class="editColumnText">
                    <html:multibox property="options"
                                   value="<%= Integer.toString(ProjectUtilities.OPTION_LITERAL_HISTORY_HTML) %>"/>
                </td>
            ...
            <tr>
                <td class="editColumnText">
                    <html:multibox property="options"
                                   value="<%= Integer.toString(ProjectUtilities.OPTION_NO_ATTACHMENTS) %>"/>
                </td>
            ...
            <c:if test="${allowSelfRegister}">
                <tr>
                    <td class="editColumnText"><html:multibox property="options"
                                                              value="<%= Integer.toString(ProjectUtilities.OPTION_ALLOW_SELF_REGISTERED_VIEW_ALL) %>"/></td>
...
<tr>
    <td colspan="4"><html:img module="/" page="/themes/defaulttheme/images/blank.gif" height="15" width="1"/></td>
</tr>
...
<tr class="editColumnTitle">
    <td colspan="4"><it:message key="itracker.web.attr.customfields"/>:</td>
</tr>
<tr class="listHeading">
    <td colspan="4"><html:img module="/" page="/themes/defaulttheme/images/blank.gif" height="2" width="1"/></td>
</tr>
...
<tr>
    <td colspan="2" valign="top">
        <table width="100%" cellspacing="0" cellspacing="1" border="0">
            ...
            <tr>
                <td class="editColumnText"><html:multibox property="fields"
                                                          value="<%= customFields.get(i).getId().toString() %>"/></td>
                <td class="editColumnText"><%= CustomFieldUtilities.getCustomFieldName(customFields.get(i).getId(), (java.util.Locale) pageContext.getAttribute("currLocale")) %>
                </td>
                <td class="editColumnText"><%= CustomFieldUtilities.getTypeString(customFields.get(i).getFieldType(), (java.util.Locale) pageContext.getAttribute("currLocale")) %>
                </td>
            </tr>
...
<tr>
    ...
    <td align="right">
        <it:formatImageAction action="editversionform"
                              paramName="projectId"
                              paramValue="<%= project.getId() %>"
                              targetAction="create"
                              src="/themes/defaulttheme/images/create.gif"
...
<tr>
    ...
    <td align="right">
        <it:formatImageAction action="editcomponentform"
                              paramName="projectId"
                              paramValue="<%= project.getId() %>"
                              targetAction="create"
                              src="/themes/defaulttheme/images/create.gif"
...
<tr align="right" class="listRowUnshaded">
    ...
    <td align="right">
        <it:formatImageAction action="editcomponentform"
                              paramName="id"
                              paramValue="<%= components.get(i).getId() %>"
                              targetAction="update"
                              src="/themes/defaulttheme/images/edit.gif"
                              altKey="itracker.web.image.edit.component.alt"
                              arg0="<%= components.get(i).getName() %>"
                              textActionKey="itracker.web.image.edit.texttag"/>
    </td>
    <td></td>
    <td><%= components.get(i).getName() %>
    </td>
    <td><%= components.get(i).getDescription() %>
    </td>
    <td><it:formatDate date="<%= components.get(i).getLastModifiedDate() %>"/></td>
    <td align="left"><%= ph.countIssuesByComponent(components.get(i).getId()) %>
    </td>
</tr>
